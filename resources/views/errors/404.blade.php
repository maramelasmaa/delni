...
<head>
    ...
    <title>{{ __('messages.public.error_404_title') }} - {{ config('app.name') }}</title>
    <style>
...
<body>
    <main class="panel-error">
        <span class="panel-error__code">404</span>
        <h1>{{ __('messages.public.error_404_title') }}</h1>
        <p>{{ __('messages.public.error_404_message') }}</p>
