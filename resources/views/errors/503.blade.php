...
<head>
    ...
    <title>{{ __('messages.public.error_503_title') }} - {{ config('app.name') }}</title>
    <style>
...
<body>
    <main class="panel-error">
        <span class="panel-error__code">503</span>
        <h1>{{ __('messages.public.error_503_title') }}</h1>
        <p>{{ __('messages.public.error_503_message') }}</p>
