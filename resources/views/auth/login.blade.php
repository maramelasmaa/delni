...
@section('auth_subtitle')
    المتابعة باستخدام حسابك في Google
@endsection
...
@section('content')
    ...
    <a href="{{ route('auth.google') }}" class="auth-oauth-button auth-oauth-google" style="width: 100%; margin-top: 0;">
    ...
    <div class="auth-footer" style="margin-top: 2rem;">
        <p style="font-size: 0.78rem;">
            بتسجيل الدخول فإنك توافق على <a href="{{ route('terms') }}" style="color: inherit; text-decoration: underline;">الشروط</a> و<a href="{{ route('privacy') }}" style="color: inherit; text-decoration: underline;">سياسة الخصوصية</a>
        </p>
    </div>
@endsection
