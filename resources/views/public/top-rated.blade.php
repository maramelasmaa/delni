...
<div class="lp-wrapper market-browse">
    ...
    @if($categories && $categories->count() > 0)
        <div class="flex gap-2 overflow-x-auto scrollbar-none py-3 px-1 scroll-smooth snap-x snap-mandatory">
            @php
    ...
    <section class="market-results">
        @if($profiles && $profiles->count() > 0)
                ...
                <div class="mt-2 mb-8 px-1">
                    ...
                    <div class="grid grid-cols-3 gap-2.5 sm:gap-6 items-end justify-center max-w-xl mx-auto pt-8 pb-3 bg-gradient-to-t from-slate-50/60 to-transparent dark:from-slate-900/30 rounded-3xl border border-slate-100/40 dark:border-slate-800/20 p-4 sm:p-6 shadow-xs">
                        ...
                        <a href="{{ route('public.provider', $gold->slug) }}" class="flex flex-col items-center text-center group -translate-y-3.5 sm:-translate-y-5 transition-all duration-300 text-decoration-none">
                            ...
                            <h3 class="mt-2.5 mb-0.5 text-slate-900 dark:text-slate-100 text-xs sm:text-sm font-black line-clamp-1 w-full px-1 hover:text-primary transition-colors">
            ...
            <div class="flex gap-3 overflow-x-auto scrollbar-none py-2 px-1 scroll-smooth snap-x snap-mandatory md:grid md:grid-cols-2 lg:grid-cols-3 lg:gap-4.5 md:overflow-x-visible">
