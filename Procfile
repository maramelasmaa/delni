...
web: php scripts/update-sw-version.php && mkdir -p storage/app/public storage/framework/cache storage/framework/sessions storage/framework/views storage/logs && php artisan storage:link --force && php artisan serve --host=0.0.0.0 --port=$PORT
